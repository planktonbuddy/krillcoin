...
const string strMessageMagic = "Krillcoin Signed Message:\n";
...
{
    double weight = GetPoSKernelPS(pindexLast);
...
bool ProcessBlock(CNode* pfrom, CBlock* pblock)
{
    ...
    /*
     this check isn't always working as intended and can cause the chain to fork
     or stall completely
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Krillcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
